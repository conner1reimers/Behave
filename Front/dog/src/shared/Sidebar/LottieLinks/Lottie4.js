...
import animationData from './ico3.json';
...
const Lottie4 = () => {
    ...
    const complica = async () => {
        ...
        return (
            <div className="spin lotto ico" onMouseOver={() => setIsVis(true)} onMouseLeave={mouseLeaveHandler} onMouseEnter={mouseOverHandler}>
                            <Lottie
                            ref={onRefLottie}
                            ...
                            width={40}
                            />
                            <span className={`lotto-label ${isVis ? 'vis' : 'hid'}`}>Account</span>
